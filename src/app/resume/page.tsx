                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-1">
                    {resumeData.skills.map((s) => (
                      <span key={s} className="px-2 py-1 bg-white rounded-md text-xs font-medium text-indigo-700 border border-indigo-200">
                        {s}
                      </span>
                    ))}
                  </div>
                  ...
                  <div key={i} className="p-3 bg-white rounded-xl border border-blue-200">
                    ...
                    {proj.tech.length > 0 && (
                      <div className="flex flex-wrap gap-1 mt-2">
                        {proj.tech.map((t) => (
                          <span key={t} className="px-1.5 py-0.5 bg-blue-100 rounded text-xs text-blue-700">{t}</span>
                        ))}
                      </div>
                    )}
                  </div>
